      ...
      <td valign="top">
	   <h4 class="h4forTopRtHeading">Feedback</h4>
          ...
          <div id="Para4MainAbout" >
		   <img src="images/Icons/FeedBackIcon.png" width="72" height="72" class="noBord" id="imgThmb">
		  
<script language="javascript" src="nbstyles/feedbackchk.js">

</script>
<form action="feedbk.php" method="post" name="frmEnquiry" onSubmit="return checkform();">      
    <table border=0 cellpadding=2 cellspacing=0 width="400">
      ...
      <tr> 
        <td width="16" align=right class="pp">&nbsp;</td>
        <td width="92" align=right class="nbox"><div align="left">Full Name * 
          </div></td>
        <td colspan="2"> <input name=txtname type=text class="formtextboxborder" value='' size=40 maxlength=50></td>
      </tr>
      <tr> 
        <td width="16" align=right class="pp">&nbsp;</td>
        <td width="92" align=right class="nbox"><div align="left">Email *</div></td>
        <td colspan="2"> <input name=txtemail type=text class="formtextboxborder" value='' size=40 maxlength=100></td>
      </tr>
      <tr> 
        <td width="16" align=right class="pp">&nbsp;</td>
        <td width="92" align=right class="nbox"><div align="left">Phone/Mobile</div></td>
        <td colspan="2" class="nbox"> <input name=txttel type=text class="formtextboxborder" size=40 maxlength=100>
          should be &gt;7 numbers</td>
      </tr>
      <tr> 
        <td width="16" align=right class="pp">&nbsp;</td>
        <td width="92" align=right class="nbox"><div align="left">Address </div></td>
        <td colspan="2"> <input name=txtadd type=text class="formtextboxborder" value='' size=40 maxlength=100></td>
      </tr>
      <tr> 
        <td width="16" align=right class="pp">&nbsp;</td>
        <td width="92" align=right class="nbox"><div align="left">Subject * </div></td>
        <td colspan="2"> <input name=txtsub type=text class="formtextboxborder" id="txtsub" value='' size=40 maxlength=100></td>
      </tr>
      <tr> 
        <td width="16" align=right valign=top class="pp">&nbsp;</td>
        <td width="92" align=right valign=top class="nbox"><div align="left">Comments 
            * </div></td>
        <td colspan="2"> <textarea name=txtcom cols=60 rows=4  class="formtextboxborder"></textarea></td>
      </tr>
      <tr> 
        <td colspan="2">&nbsp;</td>
        <td width="197"> <input name="Submit" type=submit class="formbuttons" value=Submit> <input type=reset class="formbuttons" value=Clear ></td>
        <td width="79"> <p align="center"></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
        <td colspan="2" class="nbox"><font color="#FF0000">&nbsp;[ Asterisk * 
          fields are compulsory to fill ]</font></td>
      </tr>
    </table>
</form>
  ...
  <div id="naviStyle">&nbsp;<a href="index.php" class="bottomPathNaviLinksStyles">Home</a>\<a href="fbacks.php" class="bottomPathNaviLinksStyles">Feedback</a></div>
  <!-- InstanceEndEditable -->
</div>
